...
def export_patches(repo, out_dir, patch_range=None, dry_run=False):
  print("Exporting patches in {}".format(repo))
  print("Exporting to {}".format(out_dir))
  print("Patch range: {}".format(patch_range))
  ...
  if patch_range is None:
    ...
    print("Guessing base commit: {}".format(patch_range))
    print("Guessing number of patches: {}".format(num_patches))
